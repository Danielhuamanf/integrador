         ...
         <tbody>
            ...
            <tr>
               <td>
                  <div class="user">
                     <div class="avatar">
                        {{ strtoupper(substr($almacen->nombre_almacen,0,1)) }}
                     </div>
                     {{ $almacen->nombre_almacen }}
                  </div>
               </td>
               <td>{{ $almacen->direccion }}</td>
               <td>{{ $almacen->nombre_responsable }}</td>
               <td>{{ $almacen->numero_responsable }}</td>
               <td>{{ $almacen->capacidad_m3 }} m³</td>
               <td>
                  @if($almacen->estado == 1)
				    ...
				    <div class="actions">
				        ...
				        <button
				            ...
				            onclick="editarAlmacen(
				                '{{ $almacen->id_almacen }}',
				                '{{ addslashes($almacen->nombre_almacen) }}',
				                '{{ addslashes($almacen->direccion) }}',
				                '{{ addslashes($almacen->nombre_responsable) }}',
				                '{{ $almacen->numero_responsable }}',
				                '{{ $almacen->tipo }}',
				                '{{ $almacen->estado }}',
				                '{{ $almacen->capacidad_m3 }}',
				                '{{ $almacen->id_zona }}'
				            )">
				            <i class="fa fa-pen"></i>
				        </button>
				        ...
				        <a
				            ...
				            href="{{ url('almacen/delete/'.$almacen->id_almacen) }}"
				        ...
				        <a
				            ...
				            href="{{ url('almacen/productos/'.$almacen->id_almacen) }}">
				            <i class="fa fa-box"></i>
				        </a>
