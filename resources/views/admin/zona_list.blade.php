         ...
         <tbody>
            ...
            <tr>
               <td>
                  <div class="user">
                     <div class="avatar">
                        {{ strtoupper(substr($zona->nombre_zona,0,1)) }}
                     </div>
                     {{ $zona->nombre_zona }}
                  </div>
               </td>
               ...
               <td>
                  <div class="actions">
                     <button
                        ...
                        onclick="editarZona(
                           '{{ $zona->id_zona }}',
                           '{{ addslashes($zona->nombre_zona) }}',
                           '{{ addslashes($zona->descripcion) }}',
                           '{{ addslashes($zona->direccion) }}'
                        )">
                        <i class="fa fa-pen"></i>
                     </button>
...
<script>
   function abrirModal(){
      ...
      document.getElementById('formZona').action='{{ route("zonas.store") }}';
