{{-- resources/views/cliente/mis_ordenes.blade.php --}}
            ...
            <tbody>
                ...
                @forelse($ordenes as $orden)
                    ...
                    <tr>
                        ...
                        <td>
                            {{ $orden->zonaOrigen->nombre_zona ?? '-' }}
                        </td>

                        <td>
                            {{ $orden->zonaDestino->nombre_zona ?? '-' }}
                        </td>
                        ...
                        <td>
                            {{ \Carbon\Carbon::parse($orden->fecha_envio)->format('d/m/Y') }}
                        </td>
                        ...
                        <td>
                            ...
                            <a
                                href="{{ route('detalle_orden.show',$orden->id_envio) }}"
                                class="btn-detail"
                            >
                                Ver detalle
                            </a>
