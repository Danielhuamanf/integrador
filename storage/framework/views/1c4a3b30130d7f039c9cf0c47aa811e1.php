...
<div class="main">
    ...
    <form action="<?php echo e(route('ventas.guardar.costos', $envio->id_envio)); ?>"
    method="POST">
            ...
            <div>
                ...
                <div class="card">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text"
                            value="<?php echo e($envio->cliente->nombre_completo ?? ''); ?>"
                            readonly>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text"
                            value="<?php echo e($envio->peso); ?> KG"
                            readonly>
                    ...
                    <div class="row">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text"
                            value="<?php echo e($envio->volumen); ?>"
                            readonly>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text"
                            value="<?php echo e($envio->valor_declarado); ?>"
                            readonly>
                ...
                <div class="card">
                    ...
                    <div class="form-group">
                        ...
                        id="monto"
                        name="monto"
                        value="<?php echo e($precio->monto ?? 0); ?>">
...
</html><?php /**PATH C:\xampp\htdocs\integrador\resources\views/admin/add_venta2.blade.php ENDPATH**/ ?>