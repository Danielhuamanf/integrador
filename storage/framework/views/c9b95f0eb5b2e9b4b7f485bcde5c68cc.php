...
<div class="main">
    <div class="topbar">
        ...
        <div class="actions">
            <form method="POST" action="<?php echo e(route('incidencias.importar')); ?>">
                <?php echo csrf_field(); ?>
                <button class="btn-secondary"><i class="fa fa-envelope-open-text"></i> Importar correos</button>
            </form>
            <a href="<?php echo e(route('incidencias.create')); ?>" class="btn-primary"><i class="fa fa-plus"></i> Nueva Incidencia</a>
        </div>
    </div>
    ...
    <form method="GET">
        <div class="filter-row">
            <input type="text" name="buscar" value="<?php echo e(request('buscar')); ?>" placeholder="Codigo, asunto, remitente o descripcion">
            <select name="estado">
                ...
                <option value="<?php echo e($valor); ?>" <?php echo e(request('estado')==$valor?'selected':''); ?>><?php echo e($texto); ?></option>
            ...
            <select name="prioridad">
                ...
                <option value="<?php echo e($valor); ?>" <?php echo e(request('prioridad')==$valor?'selected':''); ?>><?php echo e($texto); ?></option>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
            </select>
            <select name="modulo_afectado">
                ...
                <option value="<?php echo e($valor); ?>" <?php echo e(request('modulo_afectado')==$valor?'selected':''); ?>><?php echo e($texto); ?></option>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
            </select>
            <select name="id_usuario_asignado">
                ...
                <option value="<?php echo e($u->id_usuario); ?>" <?php echo e(request('id_usuario_asignado')==$u->id_usuario?'selected':''); ?>><?php echo e($u->username); ?></option>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
            </select>
    ...
    <div class="card">
        <div class="card-header">
            ...
            <span style="background:rgba(255,255,255,.2);padding:3px 12px;border-radius:20px;font-size:12px;"><?php echo e($incidencias->total()); ?> registros</span>
        </div>
        <div style="overflow-x:auto;">
            <table>
                ...
                <tbody>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $incidencias; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                    <tr>
                        <td><strong><?php echo e($i->codigo ?? ('#'.$i->id_incidencia)); ?></strong><div class="text-muted"><?php echo e(ucfirst($i->origen ?? 'manual')); ?></div></td>
                        <td><?php echo e($i->titulo); ?></td>
                        <td><?php echo e($i->remitente ?? $i->creador->username ?? 'Sin remitente'); ?><div class="text-muted"><?php echo e($i->correo_remitente); ?></div></td>
                        <td><span class="tag tag-<?php echo e($i->estado); ?>"><?php echo e($estados[$i->estado] ?? ucfirst(str_replace('_',' ', $i->estado))); ?></span></td>
                        <td><span class="tag tag-<?php echo e($i->prioridad); ?>"><?php echo e($prioridades[$i->prioridad] ?? ucfirst($i->prioridad)); ?></span></td>
                        <td><?php echo e($modulos[$i->modulo_afectado] ?? ($i->modulo_afectado ?: '-')); ?></td>
                        <td><?php echo e($i->asignado->username ?? '-'); ?></td>
                        <td><?php echo e($i->fecha_recepcion ? $i->fecha_recepcion->format('d/m/Y H:i') : \Carbon\Carbon::parse($i->created_at)->format('d/m/Y H:i')); ?></td>
                        <td><a href="<?php echo e(route('incidencias.show', $i->id_incidencia)); ?>" class="btn-sm"><i class="fa fa-eye"></i> Ver</a></td>
                    </tr>
        ...
        <div class="footer-card">
            <small class="text-muted">Mostrando <?php echo e($incidencias->firstItem() ?? 0); ?> - <?php echo e($incidencias->lastItem() ?? 0); ?> de <?php echo e($incidencias->total()); ?></small>
            <?php echo e($incidencias->withQueryString()->links('pagination::bootstrap-5')); ?>
...
<?php /**PATH D:\xampp\htdocs\integrador\resources\views/admin/incidencias/index.blade.php ENDPATH**/ ?>