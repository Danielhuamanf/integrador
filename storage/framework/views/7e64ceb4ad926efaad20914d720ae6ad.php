                ...
                <tr>
                    <td>
                        <div class="user">
                            ...
                            <?php echo e($documento->nombre_doc); ?>

                        </div>
                    </td>
                    <td><?php echo e($documento->envio->id_envio ?? '-'); ?></td>
                    <td><?php echo e($documento->descripcion_doc); ?></td>
                    <td><?php echo e($documento->created_at); ?></td>
                    <td><span class="estado activo">Cargado</span></td>
                    <td>
                        <div class="actions">
                            <button class="btn-action edit" onclick="editarDocumento('<?php echo e($documento->id_documento); ?>','<?php echo e(addslashes($documento->id_envio)); ?>','<?php echo e(addslashes($documento->nombre_doc)); ?>','<?php echo e(addslashes($documento->descripcion_doc)); ?>')"><i class="fa fa-pen"></i></button>

                            <form method="POST" action="<?php echo e(route('documentos.destroy',$documento->id_documento)); ?>" style="display:inline;">
                                <?php echo csrf_field(); ?>
                                <?php echo method_field('DELETE'); ?>
                                <button class="btn-action delete" onclick="return confirm('¿Eliminar documento?')"><i class="fa fa-trash"></i></button>
                            </form>

                            <a class="btn-action view" href="<?php echo e(route('documentos.ver',$documento->id_documento)); ?>" target="_blank"><i class="fa fa-eye"></i></a>
                            <a class="btn-action download" href="<?php echo e(route('documentos.download',$documento->id_documento)); ?>"><i class="fa fa-download"></i></a>
                        </div>
                    </td>
                </tr>
        ...
        <form method="POST" id="formDocumento" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <select name="id_envio" id="id_envio" required>
                    ...
                    <option value="<?php echo e($envio->id_envio); ?>"><?php echo e($envio->id_envio); ?></option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
            </div>
...
function abrirModal(){
    ...
    document.getElementById('formDocumento').action='<?php echo e(route("documentos.store")); ?>';
...
function editarDocumento(id,id_envio,nombre,descripcion){
    ...
    document.getElementById('formDocumento').action='<?php echo e(url("documentos/update")); ?>/'+id;
    document.getElementById('methodSpoof').innerHTML='<?php echo method_field("PUT"); ?>';
...
<?php /**PATH C:\xampp\htdocs\integrador\resources\views/admin/documentos_list.blade.php ENDPATH**/ ?>